...
class ItemMeanBaseline:
    ...
    def recommend_topn(self, train_df, users, n=10, candidate_items=None):
        return _recommend_by_predict_pairs(self, train_df, users, n, self.n_items_, candidate_items)
...
def _recommend_by_predict_pairs(model, train_df, users, n, n_items, candidate_items=None):
    if candidate_items is None:
        candidate_items = np.arange(n_items, dtype=int)
    else:
