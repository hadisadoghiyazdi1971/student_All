...
Method_Indices = [0, 1, 2, 3, 31, 32, 35, 36, 4, "Cor", "Hub", 37]
...
Test_Index = np.argmin(Info["Mean"].iloc[38:70]) + 38 # SGD
...
Name = Info["Method"][Test_Index]
Name = Name[Name.find("_Le"):Name.find("_Loss")]

Data = pd.DataFrame(Data, columns = Columns)
Data.to_csv("./" + FileNames[0][:FileNames[0].find("_")] +"_SGD_PinBall_T-Test" + Name +".csv", index = False)
